...
<div class="box products">
	...
	<a href="<?php echo get_permalink() ?>" title="<?php the_title(); ?>">
	       <img src="<?php bloginfo('template_directory'); ?>/timthumb.php?src=<?php echo get_post_meta($post->ID, 'rt_product_image_url', true)?>&amp;w=130&amp;zc=1" alt="<?php the_title(); ?>" class="image product_image preload" />
	</a>
	</div> 
	<?php endif;?>
	<!-- / product image -->
