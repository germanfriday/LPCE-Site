    ...
    <div class="content sub">
		...
		*/					
		...
		<?php endif;?>
							...
							<a href="<?php echo get_post_meta($post->ID, 'rt_product_image_url', true); ?>" title="<?php the_title(); ?>" rel="prettyPhoto[product]"><img src="<?php bloginfo('template_directory'); ?>/timthumb.php?src=<?php echo get_post_meta($post->ID, 'rt_product_image_url', true)?>&amp;w=250&amp;h=250&amp;zc=1" alt="" class="alignleft" /></a>
							<?php endif;?>
		...
		<?php endif;?>
					...
					*/					
					...
					<div class="panel">
						...
						if (trim($photo_url)):
						?> 
						    <li><a href="<?php echo $photo_url; ?>" title="" rel="prettyPhoto[product]"><img src="<?php bloginfo('template_directory'); ?>/timthumb.php?src=<?php echo $photo_url;?>&amp;w=130&amp;h=100&amp;zc=1" alt="" class="image portf" /></a></li>
						<?php endif;}}?>
					    </ul>
					    </div>
					</div>
