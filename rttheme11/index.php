...
<div id="slider">
    ...
    <!-- prev & next buttons -->
    <div id="numbers">
	<div class="prev"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $which_theme;?>/slider_left.gif" alt="" /></div>
	<div class="next"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $which_theme;?>/slider_right.gif" alt="" /></div>
    </div>
    <!-- / prev & next buttons -->
    <?php endif;?>
