...
class RT_THEME_NEWS_WIDGET extends WP_Widget {
	function RT_THEME_NEWS_WIDGET() {
		...
		parent::__construct( 'css-rt-theme-news-widget', 'RT-THEME NEWS WIDGET', $widget_ops );
	}
	...
	$rt_news_id= isset($instance['rt_news_id']) ?  $instance['rt_news_id'] : "";
	$rt_news_number= isset($instance['rt_news_number']) ?  $instance['rt_news_number'] : "";
