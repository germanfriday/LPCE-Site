...
class RT_THEME_BOX_WIDGET extends WP_Widget {
	function RT_THEME_BOX_WIDGET() {
		...
		parent::__construct( 'css-rt-theme-box-widget', 'RT-THEME BOX WIDGET', $widget_ops );
	}
	...
	?>    
				...
				if($box_width==4){
					...
					if(isset($this_widget_order) && fmod($this_widget_order,4)==0){
					$box_class="four last";
					$box_image_width="218";
					$clear=true;
					}else{
					...
					if(isset($this_widget_order) && fmod($this_widget_order,3)==0){
					...
					if(isset($this_widget_order) && fmod($this_widget_order,2)==0){
					$box_class="two last";
					$box_image_width="218";
					$clear=true;
					}else{
