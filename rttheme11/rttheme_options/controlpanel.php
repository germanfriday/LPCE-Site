...
if ( isset($_REQUEST['page']) && isset($_REQUEST['action']) && 'save' == $_REQUEST['action'] & 'controlpanel.php' == $_REQUEST['page'] ) {
							...
							//rttheme_pages[]
							if( isset( $_REQUEST['rttheme_pages'] ) && $_REQUEST['rttheme_pages']!=""){
							...
							if( isset( $_REQUEST['rttheme_footer_pages'] ) && $_REQUEST['rttheme_footer_pages']!=""){
							...
							if( isset( $_REQUEST['rttheme_blog_box_cat'] ) && $_REQUEST['rttheme_blog_box_cat']!=""){
							...
							//rttheme_ex_pages[]
							if( isset( $_REQUEST['rttheme_top_pages'] ) &&  $_REQUEST['rttheme_top_pages']!=""){
								$slider_category_final="";
