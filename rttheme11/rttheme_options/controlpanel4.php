...
if ( isset($_REQUEST['page']) && isset($_REQUEST['action']) && 'save' == $_REQUEST['action'] & 'controlpanel4.php' == $_REQUEST['page'] ) {
			...
			//multi select
			if( isset( $_REQUEST['rttheme_pdetail_side_pages'] ) && $_REQUEST['rttheme_pdetail_side_pages']!=""){
