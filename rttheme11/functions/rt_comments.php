  ...
  <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div class="comment-holder  <?php echo $author_comment_class;?>">
		<div class="comment-author">
			<h6><?php echo get_comment_author_link();?></h6> <span class="comment-meta"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf(__('%1$s at %2$s','rt_theme'), get_comment_date(), get_comment_time()) ?></a><?php edit_comment_link(__('(Edit)','rt_theme'),' ','') ?></span>
		</div>
		<div class="clear"></div>
